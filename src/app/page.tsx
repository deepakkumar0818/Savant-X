...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-50 relative overflow-x-hidden overflow-y-auto">
      ...
      <section className="relative py-20 px-6 sm:px-8 lg:px-12 bg-gradient-to-br from-blue-50 via-indigo-50 to-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              We have a global presence with offices and operations in multiple countries, building trust through our worldwide network.
            </p>
          </div>
          <FooterLocations />
        </div>
